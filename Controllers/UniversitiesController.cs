...
namespace UniversityApplicationSystem.Controllers
{
    public class UniversitiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Location,Description")] University university)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Location,Description")] University university)
        {
            if (id != university.Id)
            {
                return NotFound();
